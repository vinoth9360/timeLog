<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminlogin.aspx.cs" Inherits="timeLog.adminlogin" %>
                    ...
                    <div class="row align-items-center justify-content-center">
                        <div class="col-lg-6 text-center">
                            ...
                            <form method="post" action="adminlogin.aspx">
                                ...
                                <input type="number" runat="server" id="Username" required name="Username" />
                                <label for="Password">Password</label>
                                <input type="password" id="Password" required name="Password" runat="server" />
                                <input id="Submit1" type="submit" class="btn btn-primary text-white py-1 px-3 " runat="server" />
                                <%-- <button>Login</button>--%>
                                <p><b>Don't' have an account?</b><a href="signup.aspx"> Sign Up</a>.</p>
                                <p><b></b><a href="siign.aspx">User</a>.</p>
                            </form>
                            <p></p>
                        </div>
                    </div>
