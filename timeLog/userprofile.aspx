<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="userprofile.aspx.cs" Inherits="timeLog.userprofile" %>
                        ...
                        <div class="modal-content">
                         ...
                         <input id="id" runat="server" type="text" readonly="readonly">
                                        ...
                                        <div class="form_item" style="width: 117%">
                                            <label>Emp Id</label>
                                            <input type="text" id="id" runat="server" readonly="true">
                                        </div>
                                        <div class="form_item" style="width: 117%">
                                            <label>Name</label>
                                            <input type="text" id="name" runat="server" readonly="true">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form_wrap form_grp">
                                        <div class="form_item">
                                            <label>DoJ</label>
                                            <input type="text" id="date" runat="server" class="auto-style5" readonly="true">
                                        </div>
                                        <div class="form_item">
                                            <label>Current Password</label>
                                            <input type="text" id="oldpass" runat="server" class="auto-style5" readonly="true">
                                        </div>
