<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="signup.aspx.cs" Inherits="timeLog.signup" %>
                    ...
                    <div class="row align-items-center justify-content-center">
                        <div class="col-lg-6 text-center">
                            ...
                            <form method="post" action="signup.aspx">
                                <h1>SIGN UP</h1>
                                <label for="Username">Emp_Id</label>
                                <input type="text" required name="Username" runat="server" id="Username" />
                                <label for="Password">Password</label>
                                <input type="password" required name="Password" runat="server" id="Password" />
                                <input type="submit" runat="server" class="btn  btn-primary text-white py-1 px-3" value="Sign Up" width="5">
                                <%--  <button>SIGN UP</button>--%>
                                <p><b>Don't' have an account?</b><a href="siign.aspx">Sign In</a>.</p>
